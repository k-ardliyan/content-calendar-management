      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">Calendar Management</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="#"><i class="far fa-calendar"></i> <span>Calendar</span></a></li>
              <!-- <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="far fa-square"></i><span>Ex Dropdown</span></a>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Calendar Content Management</h1>
          </div>
